    ...
    <div class="header">
        ...
        <ul id="menu">
            ...
            <li <?php if ($this->checkForActiveController($filename, "recite")) { echo ' class="active" '; } ?> >
                <a href="<?php echo URL; ?>recite/index">Reciting</a>
                <ul class="sub-menu">
                        <li <?php if ($this->checkForActiveController($filename, "recite")) { echo ' class="active" '; } ?> >
                            <a href="<?php echo URL; ?>recite/index">Start Reciting</a>
                        </li>
                        <li <?php if ($this->checkForActiveController($filename, "recite")) { echo ' class="active" '; } ?> >
                            <a href="<?php echo URL; ?>recite/plan">Planning</a>
                        </li>
                 </ul>
            </li>
            <?php endif; ?>
            ...
            <li <?php if ($this->checkForActiveController($filename, "reading")) { echo ' class="active" '; } ?> >
                <a href="<?php echo URL; ?>reading/index">Reading</a>
            </li>
            <?php endif; ?>
